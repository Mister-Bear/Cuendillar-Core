...
def node_choose_class(caller):
    ...
    options = [
        {"key": "1", "desc": "Channeler", "goto": ("node_assign_power_strength", {"class": "Channeler"})},
        {"key": "2", "desc": "Warrior", "goto": ("node_assign_str", {"class": "Warrior"})},
        {"key": "3", "desc": "Rogue", "goto": ("node_assign_str", {"class": "Rogue"})},
        {"key": "4", "desc": "Scholar", "goto": ("node_assign_str", {"class": "Scholar"})},
        {"key": "5", "desc": "Performer", "goto": ("node_assign_str", {"class": "Performer"})},
        {"key": "6", "desc": "Merchant", "goto": ("node_assign_str", {"class": "Merchant"})},
    ]

    return text, options

# Node 2: Assign Power Strength (for Channelers only)
def node_assign_power_strength(caller, raw_input, **kwargs):
    ...
    caller.ndb.buybuild_data["power_strength"] = 5  # Default
    ...
    return text, [{"key": "_default", "goto": "node_assign_control"}]
